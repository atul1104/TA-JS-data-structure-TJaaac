...
console.log(person2.firstName); // "Arya" because the firstName is changed in original address because of copy by reference.
...
console.log(personTwo.firstName); // "John" personTwo creates totally new object and its independent address therefore there is no change is in the object-person.
console.log(person.firstName); // "Arya"
...
// Your code goes here
let clonedBlogs = [{ ...blog[0] }, { ...blog[1] }, { ...blog[2] }];
```
...
// Your code goes here
let allBlogsClone = {
  ...allBlogs, auther:{...allBlogs.auther}, comments: [allBlogs.comments[0], allBlogs.comments[1]];
};
```
